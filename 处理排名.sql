...
Date: 2019-03-28 22:27:53
*/

-- SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `处理排名`
-- ----------------------------
-- DROP TABLE IF EXISTS `处理排名`;
-- CREATE TABLE `处理排名` (
...
-- Records of 处理排名
-- ----------------------------
-- INSERT INTO `处理排名` VALUES ('铁岭县', '23');
-- INSERT INTO `处理排名` VALUES ('清河区', '20');
-- INSERT INTO `处理排名` VALUES ('开源市', '14');
-- INSERT INTO `处理排名` VALUES ('西丰县', '10');
-- INSERT INTO `处理排名` VALUES ('西丰县', '8');
-- INSERT INTO `处理排名` VALUES ('西丰县', '8');
